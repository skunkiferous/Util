...
public class SlidingTimeWindowReservoir implements Reservoir {
    ...
    private final TreeMap<Long, Long> measurements;
     ...
     */
    public SlidingTimeWindowReservoir(final long window,
     ...
     */
    public SlidingTimeWindowReservoir(final long window,
            final TimeUnit windowUnit, final Clock clock) {
        this.clock = clock;
        this.measurements = new TreeMap<Long, Long>();
