 ...
 * @since 1.2
 */
public class TreeMap<K, V> extends AbstractMap2<K, V> implements
    ...
    static final class SubMap<K, V> extends AbstractMap2<K, V> implements
    ...
    static abstract class NavigableSubMap<K, V> extends AbstractMap2<K, V>
    ...
    final AbstractMap2.SimpleImmutableEntry<K, V> newImmutableEntry(
            TreeMap.Entry<K, V> entry) {
