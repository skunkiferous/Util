...
public class MagicAnnotationProcessor implements RegisterGlobalsParticipant<NamedElement>, CodeGenerationParticipant<NamedElement>, TransformationParticipant<MutableNamedElement> {
  ...
  private <TD extends TypeDeclaration> void loop(final List<? extends NamedElement> annotatedSourceElements, final String phase, final Procedure3<Map<String, Object>, Processor, TD> lambda, final Procedure3<Map<String, Object>, Processor, String> lambdaAfter) {
    ...
    if (_tripleNotEquals) {
      ...
      final Processor<?, ?>[] processors = MagicAnnotationProcessor.getProcessors(annotatedSourceElements);
      ...
      MagicAnnotationProcessor.processorUtil.warn(MagicAnnotationProcessor.class, "loop", null, _plus_1);
      ...
      MagicAnnotationProcessor.processorUtil.debug(MagicAnnotationProcessor.class, "loop", null, _plus_2);
      ...
      for (final String t : _map_1) {
        ...
        if (_tripleEquals) {
          ...
          MagicAnnotationProcessor.processorUtil.error(MagicAnnotationProcessor.class, "loop", null, 
          ...
          for (final Processor<?, ?> p : processors) {
            {
              ...
              try {
                ...
                if (_tripleEquals_2) {
                  ...
                  Class<? extends Processor> _class = p.getClass();
                  ...
                  if (_tripleEquals_3) {
                    ...
                    if ((!(accept).booleanValue())) {
                      MagicAnnotationProcessor.processorUtil.debug(MagicAnnotationProcessor.class, "loop", td, 
                ...
                if (_t_1 instanceof MissingTypeException) {
                  ...
                  MagicAnnotationProcessor.processorUtil.error(MagicAnnotationProcessor.class, "loop", td, _plus_7);
                } else if (_t_1 instanceof Throwable) {
                  final Throwable t_1 = (Throwable)_t_1;
                  String _plus_8 = (p + ": ");
                  String _plus_9 = (_plus_8 + qualifiedName);
                  MagicAnnotationProcessor.processorUtil.error(MagicAnnotationProcessor.class, "loop", td, _plus_9, t_1);
                } else {
   ...
   */
  private static synchronized Processor<?, ?>[] getProcessors(final List<? extends NamedElement> annotatedSourceElements) {
    Processor<?, ?>[] _xblockexpression = null;
    {
      ...
      if (_equals) {
        ...
        if (_equals_1) {
          String[] _findProcessorNames = MagicAnnotationProcessor.findProcessorNames(compilationUnit, element);
        ...
        for (final String name : names) {
          try {
            ...
            if (_t instanceof Exception) {
              ...
              MagicAnnotationProcessor.processorUtil.error(MagicAnnotationProcessor.class, "getProcessors", null, 
   ...
   */
  private static String[] findProcessorNames(final CompilationUnitImpl compilationUnit, final Element element) {
    String[] _xblockexpression = null;
    {
      ...
      boolean _exists = _fileSystemSupport.exists(file);
      if (_exists) {
        try {
          MutableFileSystemSupport _fileSystemSupport_1 = compilationUnit.getFileSystemSupport();
          final CharSequence content = _fileSystemSupport_1.getContents(file);
          ...
          if (_isEmpty) {
            MagicAnnotationProcessor.processorUtil.warn(MagicAnnotationProcessor.class, "findProcessorNames", null, 
            ...
            for (final String name : _array) {
              try {
                ...
                if ((!(_newInstance instanceof Processor))) {
                  ...
                  String _plus = ((name + " is not a ") + _name);
                  throw new ClassCastException(_plus);
                }
              } catch (final Throwable _t) {
                if (_t instanceof Exception) {
                  final Exception ex = (Exception)_t;
                  MagicAnnotationProcessor.processorUtil.error(MagicAnnotationProcessor.class, "findProcessorNames", null, 
                    (("Could not instantiate processor for \'" + name) + "\'"), ex);
                  list.remove(name);
                } else {
                  throw Exceptions.sneakyThrow(_t);
          ...
          if (_t_1 instanceof Exception) {
            ...
            MagicAnnotationProcessor.processorUtil.error(MagicAnnotationProcessor.class, "findProcessorNames", null, 
              (("Could not read/process \'" + file) + "\'"), ex_1);
          } else {
            throw Exceptions.sneakyThrow(_t_1);
          }
        }
