...
class IsInterfaceFilter implements Filter {
  public boolean apply(final Map<String, Object> processingContext, @Extension final ProcessorUtil processorUtil, final TypeDeclaration td) {
    return (td instanceof InterfaceDeclaration);
  }
  
  public IsInterfaceFilter() {
    super();
  }
  ...
  public boolean equals(final Object obj) {
    ...
    if (getClass() != obj.getClass())
      return false;
    IsInterfaceFilter other = (IsInterfaceFilter) obj;
    return true;
  }
