...
public final class System {
    ...
    private static final HashMap<String, String> SYSTEM_PROPERTIES = new HashMap<String, String>();
  ...
  static {
      ...
      SYSTEM_PROPERTIES.put("user.home", "/");
  }
...
//    Array.prototype.splice.apply(dest, [destOfs, len].concat(src.slice(srcOfs, srcOfs + len)));
  ...
  public static String getProperty(final String key, final String def) {
      final String result = SYSTEM_PROPERTIES.get(key);
  ...
  public static String clearProperty(final String key) {
      return SYSTEM_PROPERTIES.remove(key);
  }
}
