 ...
 * @author monster
 */
public class AsyncRequestStImplWithData<RESPONSE_TYPE> extends
        AsyncRequestStImpl<RESPONSE_TYPE> implements
     ...
     */
    public AsyncRequestStImplWithData(final Reactor _targetReactor) {
     ...
     * @param _targetReactor
     */
    public AsyncRequestStImplWithData(
